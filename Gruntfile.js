...
module.exports = function(grunt) {
    ...
    grunt.registerTask('build_prod', 'Builds the project with production settings', ['adaptive-clean_build','iconpack','lint:prod','adaptive-compile-css__prod','adaptive-build_prod']);
